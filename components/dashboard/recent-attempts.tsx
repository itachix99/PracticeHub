    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            No attempts yet. Start an exam from the library.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Link href="/exams">
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Recent Attempts</CardTitle>
        <CardDescription>
          Last {attempts.length} attempts • Click to view result
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          {attempts.map((a) => (
            ...
            >
              ...
              <div className="flex gap-2">
                <Link href={`/exam/${a.examSlug}`}>
                  <Button size="sm" variant="outline">
                    Retake
                  </Button>
                </Link>
                {a.resultId && (
                  <Link href={`/exam/${a.examSlug}/result/${a.id}`}>
