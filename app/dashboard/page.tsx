        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="flex flex-col gap-2">
              ...
              {uploader.totalUploads > 0 && (
                <Link href="/dashboard/uploads">
                  <Button variant="outline" className="w-full justify-start">
                    Review Queue (
                    {uploader.uploadsByStatus["REVIEW_REQUIRED"] ?? 0})
                  </Button>
                </Link>
              )}
      ...
      {uploader.totalUploads > 0 || student.totalAttempts > 0 ? null : (
        <Card className="mt-6">
          ...
          <CardContent className="space-y-2 text-sm">
            <p>
              • Upload a previous-year paper PDF at{" "}
              <Link href="/dashboard/uploads" className="underline">
                Uploads
              </Link>{" "}
              → it will be extracted, OCRed, and AI-parsed.
            </p>
            <p>
              • Review & publish it, then appears in{" "}
            ...
            <p>
              • Start an exam from the library to generate your first attempt
